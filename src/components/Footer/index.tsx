    ...
    <Box sx={{
      ...
      <Grid container spacing={2} justifyContent="center">
        <Grid item lg={4}>
          ...
          <List>
            <ListItemText>
              <Typography variant="caption">Dr. Celemente Garcia Gerardo</Typography>
            </ListItemText>
            <ListItemText>
              <Typography variant="caption">Martha Estela Valenzuela Tirado</Typography>
            </ListItemText>
          </List>
        </Grid>
        <Grid item lg={4}>
          ...
          <List>
            ...
            <ListItemText>
              <Typography variant="caption">Espinosa Lopez Daniel Alejandro</Typography>
            </ListItemText>
            <ListItemText>
